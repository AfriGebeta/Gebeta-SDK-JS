    ...
    <div style={{ width: '100%', height: '100%', position: 'relative', overflow: 'hidden' }}>
      {route !== '/' && (
        <a
          href="#/"
          style={{
            position: 'absolute', bottom: 12, right: 12, zIndex: 2000,
            background: 'white', color: '#007cbf', textDecoration: 'none',
            padding: '6px 12px', borderRadius: 6, fontSize: 13,
            boxShadow: '0 2px 8px rgba(0,0,0,0.15)', border: '1px solid #e9ecef',
          }}
        >
          ← Back to examples
        </a>
