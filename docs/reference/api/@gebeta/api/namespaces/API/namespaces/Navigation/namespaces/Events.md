[Documentation](../../../../../../../index.md) / [@gebeta/api](../../../../../index.md) / [API](../../../index.md) / [Navigation](../index.md) / Events
...
```ts
type OffRouteEvent: OffRouteEvent;
```
...
```ts
type StepChangeEvent: StepChangeEvent;
```
